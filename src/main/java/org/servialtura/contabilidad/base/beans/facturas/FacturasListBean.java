package org.servialtura.contabilidad.base.beans.facturas;
...
@ManagedBean(name = "facturasListBean")
@ViewScoped
public class FacturasListBean extends BaseBean implements Serializable {
