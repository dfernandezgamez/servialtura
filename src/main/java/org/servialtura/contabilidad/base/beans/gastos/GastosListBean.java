package org.servialtura.contabilidad.base.beans.gastos;
...
@ManagedBean(name = "gastosListBean")
@ViewScoped
public class GastosListBean extends BaseBean implements Serializable {
