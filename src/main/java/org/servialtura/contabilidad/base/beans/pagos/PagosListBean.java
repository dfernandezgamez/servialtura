package org.servialtura.contabilidad.base.beans.pagos;
...
@ManagedBean(name = "pagosListBean")
@ViewScoped
public class PagosListBean extends BaseBean implements Serializable {
