package org.servialtura.contabilidad.base.beans.empleados;
...
@ManagedBean(name = "empleadosListBean")
@ViewScoped
public class EmpleadosListBean extends BaseBean implements Serializable {
    ...
    private Solicitud editSolicitud = new Solicitud();
    ...
    public void init(){
    	...
    	try {
			this.solicitudes= solicitudesService.getSolicitudes();
			 ...
			 FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "Error", "Error reciviendo las solicitudes"));
		}
    }
